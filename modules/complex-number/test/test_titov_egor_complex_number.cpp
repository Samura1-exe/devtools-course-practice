...
TEST(Titov_Egor_ComplexNumberTest, create_complex_number_correct) {
  double re = 3.0;
  double im = 0.1;
...
TEST(Titov_Egor_ComplexNumberTest, comparing_correct) {
  double re1 = 3.0;
  double im1 = 0.2;
...
TEST(Titov_Egor_ComplexNumberTest, equation_correct) {
  double re = 3.0;
  double im = 0.1;
...
TEST(Titov_Egor_ComplexNumberTestt, copy) {
...
TEST(Titov_Egor_ComplexNumberTest, copied_number_correct) {
  double re = 3.0;
  double im = 0.1;
...
TEST(Titov_Egor_ComplexNumberTest, change_correct) {
  double re1 = 3.0;
  double im1 = 0.1;
...
TEST(Titov_Egor_ComplexNumberTest, addition_correct) {
  double re1 = 2.0;
  double im1 = 0.1;
...
TEST(Titov_Egor_ComplexNumberTest, substraction_corrrect) {
  double re1 = 5.0;
  double im1 = 0.8;
...
TEST(Titov_Egor_ComplexNumberTest, comparasing2_correct) {
  double re1 = 13.0;
  double im1 = 0.5;
...
TEST(Titov_Egor_ComplexNumberTest, division_correct) {
...
TEST(Titov_Egor_ComplexNumberTest, division_with_zero) {
  double re1 = 1.5;
  double im1 = 2.75;
