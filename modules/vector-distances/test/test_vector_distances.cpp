...
TEST(VectorDistanceTest, can_create_vector) {
  // Arrange
  std::vector<float> _v = {1.0, 2.0, 3.0};

  // Act
  DistanceCalculator v(_v);
...
TEST(VectorDistanceTest, can_copy_vector) {
  // Arrange
  std::vector<float> _v = {1.0, 2.0, 3.0};

  // Act
  DistanceCalculator v1(_v);
  DistanceCalculator v2(v1);
...
TEST(VectorDistanceTest, can_set_data) {
  // Arrange
  std::vector<float> _v = {1.0, 2.0, 3.0};

  // Act
  DistanceCalculator v1({0, 0, 0});
  v1.setData(_v);
  std::vector<float> data;
  v1.getData(&data);
...
TEST(VectorDistanceTest, can_assign_vector) {
  // Arrange
  std::vector<float> _v = {1.0, 2.0, 3.0};

  // Act
  DistanceCalculator v1(_v);
  DistanceCalculator v2({0, 0, 0});
  v2 = v1;
  std::vector<float> data1, data2;
  v1.getData(&data1);
  v2.getData(&data2);
...
TEST(VectorDistanceTest,
  ...
  DistanceCalculator v1(_v1);
  DistanceCalculator v2(_v2);

  // Assert
  ASSERT_ANY_THROW(v1.Linf(v2));
}

TEST(VectorDistanceTest, Linf_empty_vectors_throw) {
  // Arrange
...
TEST(VectorDistanceTest, Linf_equal) {
  // Arrange
...
TEST(VectorDistanceTest, Lp_empty_vectors_throw) {
  // Arrange
  std::vector<float> _v1 = {};
  std::vector<float> _v2 = {};
  DistanceCalculator v1(_v1);
...
TEST(VectorDistanceTest, L1_equal) {
  // Arrange
  std::vector<float> _v1 = {1.0, 2.0, 3.0};
  std::vector<float> _v2 = {1.0, 2.0, 3.0};
  DistanceCalculator v1(_v1);
...
TEST(VectorDistanceTest, L2_equal) {
  // Arrange
  std::vector<float> _v1 = {1.0, 2.0, 3.0};
  std::vector<float> _v2 = {1.0, 2.0, 3.0};
  DistanceCalculator v1(_v1);
...
TEST(VectorDistanceTest, L3_equal) {
  // Arrange
  std::vector<float> _v1 = {1.0, 2.0, 3.0};
  std::vector<float> _v2 = {1.0, 2.0, 3.0};
  DistanceCalculator v1(_v1);
...
TEST(VectorDistanceTest, L4_equal) {
  // Arrange
  std::vector<float> _v1 = {1.0, 2.0, 3.0};
  std::vector<float> _v2 = {1.0, 2.0, 3.0};
  DistanceCalculator v1(_v1);
